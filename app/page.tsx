...
const schedule = [
  ...
  { time: "13:30", label: "Банкет", title: "Ресторан Vinity", text: "Фурштатская ул., 52 · семейный ужин, тосты и танцы." },
];
      ...
      <section className="dress-code">
        ...
        <div className="dress-copy">
          ...
          <aside className="flower-request">
            ...
            <p><strong>Корм вместо цветов</strong>Если вы планировали дополнить основной подарок букетом цветов, предлагаем вам поддержать нашу небольшую добрую инициативу — помочь животным из приюта. Можно принести пакет корма для собак или кошек. После свадьбы мы передадим всю собранную помощь приюту.</p>
          </aside>
        </div>
      </section>
