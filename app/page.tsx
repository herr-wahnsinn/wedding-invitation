      ...
      <section className="dress-code">
        ...
        <div className="dress-copy">
          ...
          <aside className="flower-request">
            ...
            <p><strong>Корм вместо цветов</strong>Если вы планировали дополнить подарок букетом, будем рады, если вместо цветов вы принесёте небольшой пакет корма для собак или кошек. После свадьбы мы передадим весь собранный корм животным в приюте. Так ваше внимание станет помощью тем, кому она особенно нужна.</p>
          </aside>
        </div>
      </section>
